...
Supported settings:
  ...
  LOCUST_TASK_SET - used to run the specified TaskSet (must be imported in this module)
  LOCUST_MIN_WAIT, LOCUST_MAX_WAIT
  COURSE_ID - course that will be tested on the target host, default is set in lms.base.LmsTasks
  COURSE_DATA - course_data module that will be used for parameters, default is set in lms.base.LmsTasks
