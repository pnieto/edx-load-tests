...
class DiscussionsApiLocust(HttpLocust):
    task_set = globals()[settings.data['LOCUST_TASK_SET']] # FullDiscussionsApiTest
    min_wait = settings.data('LOCUST_MIN_WAIT'] # 5000
    max_wait = settings.data('LOCUST_MAX_WAIT'] # 5000
